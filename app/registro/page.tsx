...
export default function RegistroPage() {
  ...
  async function enviar(evento: React.FormEvent) {
    ...
    const resultado = esquema.safeParse({ name, email, password });
    ...
    try {
      await registro(name.trim(), email, password);
    } catch (error) {
      setErrorGeneral(
  ...
  return (
    <PantallaAuth
      titulo="Empieza hoy. El primero es el más fácil."
